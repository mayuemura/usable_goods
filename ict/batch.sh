...
#~okazaki/local/bin/crfsuite learn -a ap -g5 -x -p max_iterations=20 trainDP_lmtd.f > log_file_5.txt
...
#~okazaki/local/bin/crfsuite learn -a ap -g8 -x -p max_iterations=20 trainDP_lmtd.f > log_file_8.txt
...
#~okazaki/local/bin/crfsuite learn -a ap -p max_iterations=20 -m emt.model trainDP_splt.f

#./feature.py < testDP_splt > testDP_splt.f

#~okazaki/local/bin/crfsuite tag -r -m emt.model < testDP_splt.f > taggedDP

#cat taggedDP | conlleval.py >> result.txt
